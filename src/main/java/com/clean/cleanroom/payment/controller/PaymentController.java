...
public class PaymentController {
    ...
    public ResponseEntity<PaymentPrepareResponseDto> preparePayment(
            @RequestParam("_token") String accessToken,
     ...
     *
     * @param accessToken       Access Token (쿼리 파라미터)
    ...
    public ResponseEntity<PaymentResponseDto> completePayment(
            @RequestParam("_token") String accessToken, // Access Token을 쿼리 파라미터로 받음
     ...
     *
     * @param accessToken 액세스 토큰 (쿼리 파라미터)
     * @param impUid      Port One의 고유 거래 ID
